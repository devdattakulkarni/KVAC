...
public class PatientInfoSystemCODASPYExperimentsKVACINLibrary {

    private CassandraAccessor accessor;
    private final Logger log = LoggerFactory
        .getLogger(PatientInfoSystemCODASPYExperimentsKVACINLibrary.class);
    ...
    public void insert10kKeys() throws Exception {
        ...
        for (int i = 0; i < dataSize; i++) {
            accessor.put(keyspace, columnFamily, rowKey + i, columnKey, value
                + " " + i, timestamp);
        }
    ...
    public void testGetColumnWithOneQueryToCFKVAC() throws Exception {
        ...
        do_library_get(accessor, keyspace, columnFamilyPatient, rowKeyPatient,
            columnKeyPatient);
    }

    @Test
    public void testGetColumnWithOneQueryToCFKVAC_10KRows_IN_Cassandra()
        throws Exception {
    ...
    public void testGetColumnWithTwoQueriesToCFInKVACPolicy() throws Exception {
        ...
        do_library_get(accessor, keyspace, columnFamily, rowKey, columnKey);
    }
    ...
    public void testGetColumnWithFiveQueriesToCFInKVACPolicy() throws Exception {
        ...
        patientColVal = "Has cold. No flu symptoms - 5 12345 5";
        accessor.put(keyspace, patientColFamily, patientRowkey, patientColkey,
            patientColVal, 1);
    ...
    @Test
    public void testGetColumnWith102040QueriesToCFInKVACPolicy() throws Exception {
    ...
    @Test
    public void testGetColumnWithTenQueriesToCFInKVACPolicy_bak()
        throws Exception {
        ...
        do_direct_get(accessor, keyspace, queryColumnFamily, queryRowKey,
            queryColumnKey);
    }
    ...
    private void do_library_get(CassandraAccessor accessor, String keyspace,
        String queryColumnFamily, String queryRowKey, String queryColumnKey)
        throws Exception {
        long start = System.currentTimeMillis();
